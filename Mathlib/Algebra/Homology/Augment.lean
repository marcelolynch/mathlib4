...
-/
private def truncateTo [HasZeroObject V] [HasZeroMorphisms V] (C : ChainComplex V ℕ) :
...
-/
private def toSingle₀AsComplex [HasZeroObject V] (C : ChainComplex V ℕ) (X : V)
...
-/
private def toTruncate [HasZeroObject V] [HasZeroMorphisms V] (C : CochainComplex V ℕ) :
...
-/
private def fromSingle₀AsComplex [HasZeroObject V] (C : CochainComplex V ℕ) (X : V)
