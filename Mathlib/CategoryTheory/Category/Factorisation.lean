...
private def IsInitial_initial : IsInitial (Factorisation.initial : Factorisation f) := IsInitial.ofUnique _
...
private def IsTerminal_terminal : IsTerminal (Factorisation.terminal : Factorisation f) :=
