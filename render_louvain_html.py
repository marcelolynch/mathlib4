"""Convert louvain-report.md to standalone HTML with inlined SVGs."""
import re
import os
import markdown

INPUT = "louvain-report.md"
OUTPUT = "louvain-report.html"
...
<title>What Louvain says about mathlib's natural boundaries</title>
<style>{CSS}</style>
</head>
<body>
<main>
