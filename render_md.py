"""Generic markdown → standalone HTML renderer with inlined SVGs.

Usage:
    python render_md.py <input.md> <output.html> "Optional title"
"""
import re
import os
import sys
...
TITLE = sys.argv[3] if len(sys.argv) > 3 else INPUT
